...
class TransUNet(nn.Module):
    def __init__(self, img_size, num_classes=2, in_channels=3, vit_name = 'R50-ViT-B_16'):
        super().__init__()
        self.transunet = VisionTransformer(CONFIGS[vit_name], img_size, num_classes,in_channels=in_channels)
    ...
    @staticmethod
    def loss(pred, label, num_classes=2):
        ...
        loss_dice = DiceLoss(num_classes)(pred, label, softmax=True)
        loss_ce = nn.CrossEntropyLoss()(pred, label)
