...
def resbone34():
    return ResBone(BasicBlock, [3, 4, 6, 3],replace_stride_with_dilation=[False, False, False])


def resbone50():
    return ResBone(Bottleneck, [3, 4, 6, 3],replace_stride_with_dilation=[False, False, False])

def resbone101():
    return ResBone(Bottleneck, [3, 4, 23, 3],replace_stride_with_dilation=[False, False, False])
