...
class SegBaseModel(nn.Module):
    ...
    def __init__(self, nclass=2, aux=None, backbone='resnet50', jpu=False, pretrained_base=True, **kwargs):
        super(SegBaseModel, self).__init__()
        dilated = False if jpu else True
        self.aux = aux
        self.conv0 = nn.Conv2d(6, 3, 1, 1) #add by tsing for adjust input image channel 2023/09/26
        self.nclass = nclass
